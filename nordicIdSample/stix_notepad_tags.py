...
def main() -> int:
    ...
    dll_path = os.path.join(base_dir, "native", "windows", arch, "NURAPI.dll")

    if not os.path.exists(dll_path):
        print(f"NURAPI.dll not found: {dll_path}")
        return 1

    # Make sure dependent DLL load resolves.
    ...
    try:
        ...
        print("Start scanning tags", flush=True)
